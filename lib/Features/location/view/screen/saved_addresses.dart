                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => InkWell(
                                    ...
                                    child: savedLocationItem(
                                        onRemove: () async {
                                          var locationCubit = BlocProvider.of<
                                                  LocationCubit>(
                                              context); // Store the reference

                                          await locationCubit.repo
                                              .deleteSelectedItem(
                                                  locations[index]);
                                          ...
                                          locationCubit
                                              .getAllLocations(); // Use the stored reference
                                        },
                                        context: context,
                            ...
                            children: [
                              PrimaryButton(
                                ...
                                onTap: () async {
                                  ...
                                  Position coord = await LocationRepo
                                      .determineDevicePosition();
