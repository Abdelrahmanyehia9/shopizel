...
class SearchingProducts extends StatelessWidget {
  ...
  final String color ;
   ...
   SearchingProducts({super.key , required this.collection , required this.color});
  ...
  Widget build(BuildContext context) {
    ...
    body: SingleChildScrollView(child: ProductGallery(color: color , collection: collection,))
    ) ;
  }
}
